...
class IngresosDeduccionesTrabajadores extends Model
{
    ...
    {
        return $this->belongsTo(IngresosDeducciones::class,'id_cat_ingreso_deduccion')->select('id_cat_ingreso_deduccion','cve_ingreso_deduccion','descripcion','codigo',
            DB::raw("CONCAT(descripcion,'(',cve_ingreso_deduccion,')' ) AS Ingreso"));
    }
    public function asignacionTrabajador()
    {
        return $this->belongsTo(Trabajadores::class,'id_trabajador');
    }
