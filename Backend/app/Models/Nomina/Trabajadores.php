...
class Trabajadores extends Model {
    ...
    {
        return $this->belongsTo(SaldosVacaciones::class,'id_trabajador');
    }
    ...
    {
        return $this->belongsTo(NivelesEstudios::class,'id_niveles_estudios');
    }

    public function trabajadorDatosMedicos()
    {
        return $this->hasOne(DatosMedicos::class,'id_trabajador');
    }

    public function trabajadorGrupoFamiliar()
    {
        return $this->hasMany( GruposFamiliares::class,'id_trabajador');
    }
    public function trabajadorIngresoDeduccion()
    {
        return $this->hasMany(IngresosDeducciones::class,'id_trabajador');
    }
    ...
    {
        return $this->hasOne(TrabajadoresDetalles::class,'id_trabajador');
    }
}
