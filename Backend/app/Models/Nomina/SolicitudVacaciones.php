...
class SolicitudVacaciones extends Model
{
    ...
    {
        return $this->hasMany('App\Models\SolicitudVacacionesDetalle','id_vacacion_solicitud');
    }

    public function solicitudTrabajador()
    {
        return $this->belongsTo('App\Models\Trabajadores','id_trabajador')->select('id_trabajador','id_area','id_cargo','primer_apellido','primer_nombre','segundo_apellido','segundo_nombre','codigo',DB::raw("CONCAT(primer_nombre,' ',segundo_nombre,' ',primer_apellido,' ',segundo_apellido) AS nombre_completo"),
    ...
    {
        return $this->belongsTo('App\Models\TrabajadoresDetalles','id_trabajador');
    }

    public function trabajadorCargo()
    {
        return $this->belongsTo('App\Models\Cargos','id_cargo');
    }
    public function trabajadorSaldoVacacion()
    {
        return $this->belongsTo('App\Models\SaldosVacaciones','id_trabajador');
    }
