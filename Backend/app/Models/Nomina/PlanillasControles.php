...
class PlanillasControles extends Model
{
    ...
    {
        return $this->belongsTo(PeriodosFiscales::class,'anio_proceso','periodo')->with('mesesPeriodo');
    }
    public function planillaMesProceso()
    {
        return $this->belongsTo(PeriodosMeses::class,'mes_proceso','mes')
    ...
    {
        return $this->belongsTo(CuentasContablesVista::class,'id_cuenta_contable_administrativa')->select('id_cuenta_contable','cta_contable','nombre_cuenta_completo');
    }
}
