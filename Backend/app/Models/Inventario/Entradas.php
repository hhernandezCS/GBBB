...
//        $entrada->with('entradaProveedor');
        ...
        $entrada->with('entradaDocumentoContable');
...
//        $productos->leftJoin('inventario.baterias_marcas', 'inventario.baterias_marcas.id_marca','inventario.baterias_submarcas.id_marca');
    ...
    public function entradaDocumentoContable()
    {
        return $this->belongsTo(DocumentosContables::class,'id_documento_contable')->select('*');
    }
}
