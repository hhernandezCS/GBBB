...
class Requisas extends Model {
    ...
    {
        return $this->belongsTo('App\Models\Trabajadores','id_trabajador')->select(['*',DB::raw("CONCAT(primer_nombre,' ',segundo_nombre,' ',primer_apellido,' ',segundo_apellido) AS text")]);
    }
