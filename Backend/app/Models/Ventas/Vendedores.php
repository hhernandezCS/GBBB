...
class  Vendedores extends Model
{
    ...
    protected $fillable = ['nombre_completo','direccion','telefono','telefono_movil','email','id_zona','id_bodega','observador','u_creacion','u_modificacion','estado','id_empresa','id_usuario'];
    ...
    public function obtenerVendedor($request)
    {
        $vendedores = $this->select(['*']);
        $usuario_empresa = UsuariosEmpresas::where('id_usuario', '=', Auth::user()->id)->first();
        $vendedores->where('id_vendedor', $request->id_vendedor);
        $vendedores->where('id_empresa',$usuario_empresa->id_empresa);

        $vendedores->with('usuarioVendedor');
    ...
    {
        return $this->belongsTo('App\Models\Trabajadores','id_trabajador');
    }
