...
class Areas extends Model
{
    ...
    {
        return $this->hasMany('App\Models\Trabajadores','id_area')->select('id_trabajador','id_area','primer_apellido','primer_nombre','segundo_apellido','segundo_nombre','codigo',DB::raw("CONCAT(primer_nombre,' ',segundo_nombre,' ',primer_apellido,' ',segundo_apellido) AS nombre_completo"));
    }
}
