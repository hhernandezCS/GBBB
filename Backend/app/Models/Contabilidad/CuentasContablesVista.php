 ...
 */
    ...
    {
        return $this->belongsTo(CuentasContablesVista::class,'id_cuenta_padre');
    }
    ...
    {
        return $this->belongsTo(NivelesCuentas::class,'id_nivel_cuenta');
    }
    ...
    {
        return $this->belongsTo(TiposCuentas::class,'id_tipo_cuenta');
    }
