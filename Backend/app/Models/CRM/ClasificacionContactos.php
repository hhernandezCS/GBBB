...
class ClasificacionContactos extends Model
{
    /* The above code is creating a table called tipo_contactos and a primary key called id_tipo_contacto. */
    protected $table = 'crm.clasificacion_contactos';
    protected $primaryKey='id_clasificacion_contacto';
    ...
    public function obtener($request)
    {
        ...
        $contactos->where('id_empresa',$usuario_empresa->id_empresa);
        $contactos->orderBy('id_clasificacion_contacto', 'desc');
