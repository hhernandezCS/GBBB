...
//use App\Models\CuentasXCobrarImportData;
//use PHPJasper\PHPJasper;
use App\Models\Admon\UsuariosEmpresas;
use App\Models\CuentasXCobrar\CuentasXCobrarImportData;
...
class CuentasXCobrarController extends Controller
{
    ...
    public function generarReporteAntiguedad(Request $request)
    {
        ...
        if (in_array($request->extension, $os)) {
            ...
            $input = env('APP_URL_REPORTES') . 'AntiguedadSaldos';
            $output = env('APP_URL_REPORTES') . $hora_actual . 'AntiguedadSaldos';
    ...
    public function generarReporteEstadoCuentadetallado(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            if (in_array($request->extension, $os)) {
                ...
                $input = env('APP_URL_REPORTES') . 'EstadoCuentaClienteDetalle';
                $output = env('APP_URL_REPORTES') .$hora_actual . 'EstadoCuentaClienteDetalle';
    ...
    public function generarReporteEstadoCuentaConsolidado(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            if (in_array($request->extension, $os)) {
                ...
                $input = env('APP_URL_REPORTES') . 'EstadoCuentaClienteConsolidado';
                $output = env('APP_URL_REPORTES') . $hora_actual . 'EstadoCuentaClienteConsolidado';
    ...
    public function generarReporteEstadoCuentaDetalladoEmpleado(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            if (in_array($request->extension, $os)) {
                ...
                $input = env('APP_URL_REPORTES') . 'EstadoCuentaEmpleadoDetalle';
                $output = env('APP_URL_REPORTES') . $hora_actual . 'EstadoCuentaEmpleadoDetalle';
    ...
    public function generarReporteEstadoCuentaConsolidadoEmpleado(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            if (in_array($request->extension, $os)) {
                ...
                $input = env('APP_URL_REPORTES') . 'EstadoCuentaEmpleadoConsolidado';
                $output = env('APP_URL_REPORTES') . $hora_actual . 'EstadoCuentaEmpleadoConsolidado';
    ...
    public function generarReporteEstadoCuentadetalladoOCC(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            if (in_array($request->extension, $os)) {
                ...
                $input = env('APP_URL_REPORTES') . 'EstadoCuentaClienteDetalleOtras';
                $output = env('APP_URL_REPORTES').$hora_actual.'EstadoCuentaClienteDetalleOtras';
    ...
    public function generarReporteEstadoCuentaConsolidadoOCC(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            if (in_array($request->extension, $os)) {
                ...
                $input = env('APP_URL_REPORTES') . 'EstadoCuentaClienteConsolidadoOtras';
                $output = env('APP_URL_REPORTES').$hora_actual .'EstadoCuentaClienteConsolidadoOtras';
...
//            $output = env('APP_URL_REPORTES') . $hora_actual .  'InventarioFacturasProducto';
    ...
    public function importar_datos(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            $secuencia = CuentasXCobrarImportData::select([DB::raw("COALESCE(max(cod_import),0)+1 as secuencia")])->first();
