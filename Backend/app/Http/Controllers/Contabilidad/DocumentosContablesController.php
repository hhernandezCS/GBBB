...
//                        $documento_cuenta_contable->id_centro =  (!$movimientoCuenta['centro_costo_ingreso_deshabilitada'])?$movimientoCuenta['centro_costo_ingreso']['id_centro']:null;
    ...
    public function nuevo(Request $request)
    {
        ...
        $cuentas_contables = CuentasContablesVista::orderBy('cta_contable')->where('estado',1)->where('permite_movimiento', 1)->select('id_cuenta_contable','cta_contable','nombre_cuenta','id_tipo_cuenta','nombre_cuenta_completo')->get();
