...
class TipoSalidaController extends Controller
{
    ...
    {
        $tipos_salida = TipoSalida::where('estado', 1)->where('estado',1)->get();
        return response()->json([
            'status' => 'success',
            'result' => $tipos_salida,
            'messages' => null
    ...
    public function registrar(Request $request)
    {
        $rules = [
            'descripcion' =>  [
                ...
                'string',
                'max:50',
                Rule::unique('pgsql.inventario.tipo_salidas')],
        ];
    ...
    public function actualizar(Request $request)
    {
        $rules = [
            ...
            'descripcion' =>  [
                ...
                'string',
                'max:50',
                Rule::unique('pgsql.inventario.tipo_salidas')->ignore($request->id_tipo_salida,'id_tipo_salida')],
        ];
