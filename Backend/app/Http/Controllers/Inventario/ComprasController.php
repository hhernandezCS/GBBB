...
class ComprasController extends Controller
{
    ...
    public function actualizar(Request $request)
    {
        ...
        $rules = [
            ...
            'entrada_productos.*.cantidad_solicitada' => 'required|gt:0',
    ...
    public function recibir(Request $request)
    {
        ...
        $rules = [
            ...
            'entrada_productos.*.cantidad_solicitada' => 'required|gt:0',
            'entrada_productos.*.cantidad_faltante' => 'required|min:0|lte:entrada_productos.*.cantidad_solicitada',
            'entrada_productos.*.cantidad_recibida' => 'required|min:0|lte:entrada_productos.*.cantidad_solicitada',
        ];
