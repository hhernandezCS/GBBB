...
//        echo $ext;
        ...
        if (in_array($ext, $os, true)) {
            ...
            */
            $hora_actual = time();
            $input = env('APP_URL_REPORTES') . 'InventarioProductos.jasper';
//            $output = env('APP_URL_REPORTES') . $hora_actual .  'ArticulosServicios';
            $output = env('APP_URL_REPORTES') . $hora_actual . 'InventarioProductos';
            $nameReport = 'Reporte Productos';
            $modulo = 'Inventario';
...
//            $output = env('APP_URL_REPORTES') . $hora_actual .  'TipoProducto';
    ...
    public function generarReporteCodigoBArra($ext)
    {
        // echo $ext;
        ...
        if (in_array($ext, $os)) {
            ...
            */
            $hora_actual = time();
            $input = env('APP_URL_REPORTES') . 'ProductoCodigoBarra';
            $output = env('APP_URL_REPORTES') . $hora_actual . 'ProductoCodigoBarra';
...
//            $output = env('APP_URL_REPORTES') . $hora_actual .  'TipoProducto';
            ...
            return response()->download($output . '.' . $ext, $hora_actual . 'ProductoCodigoBarra.' . $ext, $headers)->deleteFileAfterSend();
...
//            $output = env('APP_URL_REPORTES') . $hora_actual .  'ExistenciasxBodega';
    ...
    public function generarReporteExitenciaMinima($ext, $id_grupo)
    {
        // echo $ext;
        ...
        if (in_array($ext, $os)) {
            ...
            */
            $hora_actual = time();
            $input = env('APP_URL_REPORTES') . 'ExistenciaPorMinimo';
            $output = env('APP_URL_REPORTES') . $hora_actual . 'ExistenciaPorMinimo';
...
//            $output = env('APP_URL_REPORTES') . $hora_actual .  'ExistenciasxBodega';
            ...
            //Ajustes generales del sistema
            $logo_empresa = Ajustes::where('id_ajuste', 10)->select('valor')->first();
            $nombre_empresa = Ajustes::where('id_ajuste', 4)->select('valor')->first();
            ...
            return response()->download($output . '.' . $ext, $hora_actual . 'ExistenciaPorMinimo.' . $ext, $headers);
...
//            $output = env('APP_URL_REPORTES') . $hora_actual .  'ReportesGeneralServicios';
            ...
            //Ajustes generales del sistema
            $logo_empresa = Ajustes::where('id_ajuste', 16)->select('valor')->first();
            $nombre_empresa = Ajustes::where('id_ajuste', 4)->select('valor')->first();
