...
class ContratoTiposController extends Controller
{
     ...
     * @param ContratoTipos $datos
     * @return  \Illuminate\Http\JsonResponse(array)
     */

    public function obtener(Request $request, ContratoTipos $datos)
    {
    ...
    public function obtenerTodas(Request $request, ContratoTipos $datos)
    {
        $datos = ContratoTipos::orderby('id_contrato_tipo')->get();
        return response()->json([
            'status' => 'success',
            'result' => $datos,
            'messages' => null
    ...
    public function obtenerContratoTipo(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $datos = ContratoTipos::find($request->id_contrato_tipo);
