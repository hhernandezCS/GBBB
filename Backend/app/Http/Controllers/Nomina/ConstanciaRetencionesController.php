...
class ConstanciaRetencionesController extends Controller
{
    ...
    public function obtenerDeducciones(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            $comp = IngresosDeduccionesTrabajadores::where('id_trabajador',$request->id_trabajador)->where('estado',2)->with('trabajadorComprobante','cajaComprobante','solicitudComprobante','comprobanteDetalle')->get();
