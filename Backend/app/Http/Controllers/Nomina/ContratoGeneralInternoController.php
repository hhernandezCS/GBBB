...
class ContratoGeneralInternoController extends Controller
{
    /**
     ...
     * @param ContratoGeneralInterno $contrato
     * @return  \Illuminate\Http\JsonResponse(array)
     */

    public function obtener(Request $request, ContratoGeneralInterno $contrato)
    {
    ...
    public function obtenerTodas(Request $request, ContratoGeneralInterno $contrato)
    {
        $contrato = ContratoGeneralInterno::select('id_contrato_dgeneral_interno','nombre_representante','caracter_cargo','caracter_legal',
    ...
    public function registrar(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            $contrato = new ContratoGeneralInterno;
    ...
    public function actualizar(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            $contrato = ContratoGeneralInterno::find($request->id_contrato_dgeneral_interno);
            $contrato->nombre_representante = $request->nombre_representante;
            $contrato->estado_civil = $request->estado_civil;
