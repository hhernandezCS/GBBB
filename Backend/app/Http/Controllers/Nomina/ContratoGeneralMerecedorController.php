...
use App\Models\Nomina\TiposActosJuridicos;
...
class ContratoGeneralMerecedorController extends Controller
{
    /**
     ...
     * @param ContratoGeneralMerecedor $contrato
     * @return  \Illuminate\Http\JsonResponse(array)
     */

    public function obtener(Request $request, ContratoGeneralMerecedor $contrato)
    {
    ...
    public function obtenerTodas(Request $request, ContratoGeneralMerecedor $contrato)
    {
        $contrato = ContratoGeneralMerecedor::select('id_contrato_dgeneral_merecedor','nombre_representante','caracter_cargo','id_tipo_acto_juridico','caracter_legal',
    ...
    public function obtenerContratoGeneral(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $contrato = ContratoGeneralMerecedor::where('id_contrato_dgeneral_merecedor',$request->id_contrato_dgeneral_merecedor)->with('contratoMerecedorNivelEstudio','contratoMerecedorNivelAcademico','contratoMerecedorDepartamento','contratoMerecedorDepartamentoDomicilio','contratoMerecedorTipoActoJuridico','contratoMerecedorDepartamentoLibrado')->first();
            $nivel_academico = NivelesAcademicos::select('id_nivel_academico','descripcion')->get();
            $nivel_estudio = NivelesEstudios::select('id_niveles_estudios','descripcion')->get();
            $departamento = Departamentos::select('id_departamento','descripcion')->get();
            $domicilio = Departamentos::select('id_departamento','descripcion')->get();
            $departamento_librado = Departamentos::select('id_departamento','descripcion')->get();
            $tipo_acto = TiposActosJuridicos::select('id_tipo_acto_juridico','descripcion')->get();
    ...
    public function registrar(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            $contrato = new ContratoGeneralMerecedor;
    ...
    public function actualizar(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            $contrato = ContratoGeneralMerecedor::find($request->id_contrato_dgeneral_merecedor);
            $contrato->nombre_representante = $request->nombre_representante;
            $contrato->estado_civil = $request->estado_civil;
