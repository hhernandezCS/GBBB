...
class IngresosDeduccionesTrabajadoresController extends Controller
{
    /**
     ...
     * @param IngresosDeduccionesTrabajadores $solicitud
     * @return  JsonResponse(array)
     */

    public function obtener(Request $request, IngresosDeduccionesTrabajadores $solicitud)
    {
    ...
    public function obtenerTodas(Request $request, IngresosDeduccionesTrabajadores $solicitud)
    {
        $solicitud = IngresosDeduccionesTrabajadores::orderby('id_cat_ingreso_deduccion_trabajador')->with('asignacionPlanilla','asignacionTrabajador')->get();
    ...
    public function obtenerIngresoDeduccionTrabajador(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $solicitud = IngresosDeduccionesTrabajadores::where('id_trabajador',$request->id_trabajador)->first();
