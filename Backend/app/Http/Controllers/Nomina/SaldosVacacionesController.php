...
use App\Models\Nomina\Parentesco;
...
class SaldosVacacionesController extends Controller
{
     ...
     * @param SaldosVacaciones $datos
     * @return  \Illuminate\Http\JsonResponse(array)
     */

    public function obtener(Request $request, SaldosVacaciones $datos)
    {
    ...
    public function obtenerTodas(Request $request, SaldosVacaciones $datos)
    {
        $datos = SaldosVacaciones::orderby('id_vacacion_saldo')->with('saldoEmpleado')->first();
        return response()->json([
            'status' => 'success',
            'result' => $datos,
            'messages' => null
    ...
    public function obtenerSaldo(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $datos = SaldosVacaciones::find($request->id_vacacion_saldo);
