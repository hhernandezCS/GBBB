...
class TipoActoJuridicoController extends Controller
{
    /**
     ...
     * @param TiposActosJuridicos $tipo
     * @return  \Illuminate\Http\JsonResponse(array)
     */

    public function obtener(Request $request, TiposActosJuridicos $tipo)
    {
    ...
    public function obtenerTodas(Request $request, TiposActosJuridicos $tipo)
    {
        $tipo = TiposActosJuridicos::orderby('id_tipo_acto_juridico')->get();
        return response()->json([
            'status' => 'success',
            'result' => $tipo,
            'messages' => null
    ...
    public function obtenerActoJuridico(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $tipo = TiposActosJuridicos::find($request->id_tipo_acto_juridico);
