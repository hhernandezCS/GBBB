...
class DatosMedicosController extends Controller
{
     ...
     * @param DatosMedicos $datos
     * @return  \Illuminate\Http\JsonResponse(array)
     */

    public function obtener(Request $request, DatosMedicos $datos)
    {
    ...
    public function obtenerTodas(Request $request, DatosMedicos $datos)
    {
        $datos = DatosMedicos::orderby('id_dato_medico')->get();
        return response()->json([
            'status' => 'success',
            'result' => $datos,
            'messages' => null
    ...
    public function obtenerDatoMedico(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $datos = DatosMedicos::find($request->id_dato_medico);
