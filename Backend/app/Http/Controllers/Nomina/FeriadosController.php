...
class FeriadosController extends Controller
{
     ...
     * @param Feriados $feriado
     * @return  \Illuminate\Http\JsonResponse(array)
     */

    public function obtener(Request $request, Feriados $feriado)
    {
    ...
    public function obtenerTodas(Request $request, Feriados $feriado)
    {
        $feriado = Feriados::orderby('id_feriado')->get();
        return response()->json([
            'status' => 'success',
            'result' => $feriado,
            'messages' => null
    ...
    public function obtenerFeriado(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $feriado = Feriados::find($request->id_feriado);
