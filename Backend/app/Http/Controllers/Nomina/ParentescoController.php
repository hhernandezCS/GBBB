...
class ParentescoController extends Controller
{
     ...
     * @param Parentesco $datos
     * @return  \Illuminate\Http\JsonResponse(array)
     */

    public function obtener(Request $request, Parentesco $datos)
    {
    ...
    public function obtenerTodas(Request $request, Parentesco $datos)
    {
        $datos = Parentesco::orderby('id_parentesco')->get();
        return response()->json([
            'status' => 'success',
            'result' => $datos,
            'messages' => null
    ...
    public function obtenerParentesco(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $datos = Parentesco::find($request->id_parentesco);
