...
class SolicitudVacacionesController extends Controller
{
     ...
     * @param SolicitudVacaciones $solicitud
     * @return  \Illuminate\Http\JsonResponse(array)
     */

    public function obtener(Request $request, SolicitudVacaciones $solicitud)
    {
     ...
     * @access  public
     * @param Request $request
     * @param Feriados $solicitud
     * @return  \Illuminate\Http\JsonResponse(array)
     */

    public function obtenerTodas(Request $request, SolicitudVacaciones $solicitud)
    {
        $solicitud = SolicitudVacaciones::orderby('id_vacacion_solicitud')->get();
        return response()->json([
            'status' => 'success',
            'result' => $solicitud,
            'messages' => null
    ...
    public function obtenersolicitud(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $solicitud = SolicitudVacaciones::where('id_vacacion_solicitud',$request->id_vacacion_solicitud)->with('solicitudDetalle','solicitudTrabajador','trabajadorDetalles','trabajadorArea','trabajadorCargo','trabajadorSaldoVacacion')->first();
    ...
    public function nuevo(Request $request)
    {
        ...
        $periodos = PeriodosFiscales::select('id_periodo_fiscal','periodo')->with('mesesPeriodo')->get();
    ...
    public function registrar(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            try {
                ...
                $secuencia = SolicitudVacaciones::max('id_vacacion_solicitud') + 1;
    ...
    public function cambiarEstadoSolicitud(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            $solicitud = SolicitudVacaciones::where('id_vacacion_solicitud',$request->id_vacacion_solicitud)->with('solicitudTrabajador','solicitudDetalle')->first();
    ...
    public function desactivar(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), $rules);
        if (!$validator->fails()) {
            $solicitud = Feriados::find($request->id_feriado);
            $solicitud->estado = 0;
            $solicitud->save();
