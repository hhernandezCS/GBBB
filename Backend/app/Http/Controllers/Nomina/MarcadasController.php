...
class MarcadasController extends Controller
{
    /**
    ...
    public function obtener(Request $request, Marcadas $solicitud)
    {
    ...
    public function obtenerTodas(Request $request, Marcadas $solicitud)
    {
        $solicitud = Marcadas::orderby('id_marcada')->get();
    ...
    public function obtenerMarcada(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $solicitud = Marcadas::where('id_trabajador',$request->id_trabajador)->get();
    ...
    {
        $justificaciones = TiposJustificacionesMarcadas::select('id_tipo_marcada_justificacion','descripcion')->get();


        if(!empty($request->id_trabajador))
        {
            $trabajador = Trabajadores::select('id_trabajador','primer_apellido','primer_nombre','segundo_apellido','segundo_nombre','codigo',
            ...
            $marcadas = Marcadas::where('id_trabajador',$request->id_trabajador)->get();
            return response()->json([
                'status' => 'success',
                'result' => [
    ...
    public function obtenerPlanilla(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            $ingresos = Marcadas::where('id_trabajador',$request->id_trabajador)->where('id_marcada',$request->id_marcada)->where('estado',1)->with('asignacionIngreso')->get();
    ...
    public function registrar(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            try {
                ...
                //Marcadas::where('id_marcada',$request->id_marcada)->delete();
