...
class CargosController extends Controller
{
    ...
    public function obtenerCargos(Request $request, Cargos $cargos)
    {
    ...
    public function obtenerTodosCargos(Request $request, Cargos $cargos)
    {
