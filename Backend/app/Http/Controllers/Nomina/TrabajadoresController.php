...
use App\Models\Nomina\GruposFamiliares;
use Hash, Validator;
use App\Models\Nomina\TrabajadoresDetalles;
...
class TrabajadoresController extends Controller
{
    ...
    public function buscar(Request $request, Trabajadores $trabajador)
    {
    ...
    public function buscarTrabajador(Request $request, Trabajadores $trabajador)
    {
    ...
    public function obtenerTrabajadoresActivos(Request $request, Trabajadores $trabajadores)
    {
        $trabajadores = Trabajadores::where('activo', 1)->get();
        return response()->json([
            'status' => 'success',
            'result' => $trabajadores,
            'messages' => null
    ...
    public function obtener(Request $request, Trabajadores $trabajador)
    {
    ...
    public function obtenerTrabajador(Request $request, Trabajadores $trabajador)
    {
        $rules = [
	...
	public function registrar(Request $request)
	{
		...
		if (!$validator->fails()) {
			...
			DB::beginTransaction();
                ...
                $grupos = new TrabajadoresDetalles;
	...
	public function actualizar(Request $request)
	{
		...
		if (!$validator->fails()) {
			...
			$trabajador = Trabajadores::findOrFail($request->id_trabajador);
			...
			$grupos = TrabajadoresDetalles::where('id_trabajador', $trabajador->id_trabajador)->first();
			...
			if(!empty($usuario)){
                ...
                $datos = DatosMedicos::where('id_trabajador', $trabajador->id_trabajador)->first();
                ...
                GruposFamiliares::where('id_trabajador',$trabajador->id_trabajador)->delete();
                $i = 1;
    ...
    public function desactivar(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            $trabajador->u_modificacion = Auth::user()->usuario;
            $trabajador->save();
            $trabajador_detalle = TrabajadoresDetalles::find($request->id_trabajador);
