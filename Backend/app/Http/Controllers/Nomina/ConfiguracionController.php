...
use App\Models\Nomina\Configuracion;
...
class ConfiguracionController extends Controller
{
     ...
     * @param Configuracion $importacion_config
     * @return JsonResponse
     */

    public function obtener(Request $request, Configuracion $importacion_config)
    {
    ...
    public function actualizar(Request $request): JsonResponse
    {
        ...
        $rules = [
            ...
            'ajustes.*.id_configuracion_rrhh' => 'required|integer',
        ...
        if (!$validator->fails()) {
            ...
            try {
                    ...
                    foreach ($request->ajustes as $configuracion) {
                        $contabilidad_config = Configuracion::find($configuracion['id_configuracion_rrhh']);
