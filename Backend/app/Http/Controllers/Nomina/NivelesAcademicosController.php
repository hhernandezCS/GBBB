...
class NivelesAcademicosController extends Controller
{
     ...
     * @param NivelesAcademicos $nivel
     * @return  \Illuminate\Http\JsonResponse(array)
     */

    public function obtener(Request $request, NivelesAcademicos $nivel)
    {
    ...
    public function obtenerTodas(Request $request, NivelesAcademicos $nivel)
    {
        $nivel = NivelesAcademicos::orderby('id_nivel_academico')->get();
        return response()->json([
            'status' => 'success',
            'result' => $nivel,
            'messages' => null
    ...
    public function obtenerNivelAcademico(Request $request)
    {
        ...
        if (!$validator->fails()) {
            $nivel = NivelesAcademicos::find($request->id_nivel_academico);
