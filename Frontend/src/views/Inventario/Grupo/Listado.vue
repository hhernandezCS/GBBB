  ...
  <b-card>
    <b-row>
      <div class="col-md-3 sm-text-center">
        <router-link class="btn btn-success" tag="button"
                     :to="{ name: 'inventario-grupo-registrar' }">
    ...
    <div class="table-responsive mt-3">
      <table class="table table-striped table-bordered">
        ...
        <tbody>
        <template v-for="grupo in grupo">
          <tr :key="grupo.id_grupo">
            <td>{{ grupo.descripcion }}</td>
            <td>{{ grupo.codigo }}</td>
            <td class="text-center">
              <div v-if="grupo.estado===1">
            ...
            <td class="text-center">
              <template>
                <router-link v-b-tooltip="'Actualizar grupo'"
                             :to="{name: 'inventario-grupo-actualizar', params: {id_grupo: grupo.id_grupo}}"
                             tag="a">
    ...
    <b-card-footer>
      <pagination @changePage="changePage" @changeLimit="changeLimit" :items="grupo" :total="total"
