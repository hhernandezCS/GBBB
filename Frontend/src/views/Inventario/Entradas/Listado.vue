            ...
            <table class="table table-striped table-bordered">
                ...
                <template v-for="(entrada,key) in entradas">
                    <tr :key="entrada.id_entrada">
                        ...
                        <td>{{ entrada.entrada_proveedor.length > 0? entrada.entrada_proveedor[0].nombre_comercial:'N/A' }}</td>
                        ...
                        <td class="text-center">
                            <template v-if="entrada.estado===1">
                                <router-link style="padding: 3px" v-b-tooltip.hover.top="'Recibir Entrada'"
                                             :to="{ name: 'inventario-entradas-recibir', params: { id_entrada: entrada.id_entrada } }"
                                             tag="a">
                            ...
                            <template v-if="entrada.estado===99">
                                <template v-if="[5,6,7].indexOf(Number(entrada.id_tipo_entrada)) <= 0">
                                    <router-link style="padding: 3px"
                                                 v-b-tooltip.hover.top="'Actualizar Datos de Entrada'"
                                                 :to="{ name: 'inventario-entradas-actualizar', params: { id_entrada: entrada.id_entrada } }"
                                                 tag="a">
