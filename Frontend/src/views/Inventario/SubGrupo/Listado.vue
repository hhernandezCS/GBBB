  ...
  <b-card>
    <b-row>
      <div class="col-md-3 sm-text-center">
        <router-link class="btn btn-success" tag="button"
                     :to="{ name: 'inventario-subgrupo-registrar' }">
    ...
    <div class="table-responsive mt-3">
      <table class="table table-striped table-bordered">
        ...
        <tbody>
        <template v-for="subgrupo in subgrupo">
          <tr :key="subgrupo.id_subgrupo">
            <td>{{ subgrupo.descripcion }}</td>
            <td>{{ subgrupo.codigo }}</td>
            <td>{{ subgrupo.grupo.descripcion }}</td>
            <td class="text-center">
              <div v-if="subgrupo.estado===1">
            ...
            <td class="text-center">
              <template>
                <router-link v-b-tooltip="'Actualizar sub-grupo'"
                             :to="{name: 'inventario-subgrupo-actualizar', params: {id_subgrupo: subgrupo.id_subgrupo}}"
                             tag="a">
    ...
    <b-card-footer>
      <pagination @changePage="changePage" @changeLimit="changeLimit" :items="subgrupo" :total="total"
