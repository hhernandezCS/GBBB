	...
	<b-card>
		<b-row>
			<b-col class="sm-text-center" cols="12" md="6">
				<router-link class="btn btn-success" tag="button" :to="{ name: 'cxc-tipos-notas-debito-registrar' }">
				...
				<tbody>
					<tr v-for="tipo_nota_debito in tipos_nota_debito" :key="tipo_nota_debito.id_tipo_nota_debito">
						...
						<td class="text-center">
							...
							<router-link tag="a" :to="{ name: 'cxc-tipos-notas-debito-actualizar', params: { id_tipo_nota_debito: tipo_nota_debito.id_tipo_nota_debito } }"><feather-icon icon="EditIcon"></feather-icon></router-link>
							<!--</template>-->
						</td>
					</tr>
