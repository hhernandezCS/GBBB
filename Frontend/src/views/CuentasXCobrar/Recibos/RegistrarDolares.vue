    ...
    <b-row>
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <input class="form-control"  id="tc" type="text" v-model="form.t_cambio">
        </div>
      </div>
          ...
          <div class="form-group">
            ...
            <b-alert show variant="danger">
              <ul class="error-messages">
                <li
                    :key="message"
                    v-for="message in errorMessages.monto_me"
                    v-text="message"
                ></li>
              </ul>
            </b-alert>
            ...
            <tr>
              ...
              <td class="text-center" style="width: 12%">
                <input class="form-control"
                       ...
                       v-model.number="item.monto_retencion_ir_me">
              </td>
              <td class="text-center" style="width: 12%">
                <input class="form-control"
                       disabled
                       v-b-tooltip.hover.top="'No. Documento Exoneración:'+item.doc_exoneracion_imi"
                       v-model.number="item.monto_retencion_imi_me">
              </td>
...
export default {
  ...
  computed: {
    ...
    /*      filteres_pay_method(){
            let self = this;
            if(self.detalleFormPago.via_pagox){
  ...
  methods: {
    ...
    establecerConcepto(itemX) {
      ...
      let monto_retencion_ir_me = 0, monto_retencion_imi_me = 0;

      if (itemX.cuentax.cuenta_factura.impuesto_exonerado) {
        iva = 1;
      }
      if (itemX.aplicaIR) {
        monto_retencion_ir = Round.round((itemX.monto_me * self.form.t_cambio) * 0.02, 2);
        monto_retencion_ir_me = Round.round(itemX.monto_me * 0.02, 2);
      } else {
        monto_retencion_ir = 0;
        monto_retencion_ir_me = 0;
      }

      if (itemX.aplicaIMI) {
        monto_retencion_imi = Round.round((itemX.monto_me * self.form.t_cambio) * 0.01, 2);
        monto_retencion_imi_me = Round.round(itemX.monto_me * 0.01, 2);
      } else {
        monto_retencion_imi = 0;
        monto_retencion_imi_me = 0;
      }
      ...
      itemX.monto_retencion_ir_me = monto_retencion_ir_me;
      itemX.monto_retencion_imi_me = monto_retencion_imi_me;
    ...
    nuevo() {
      ...
      recibos.nuevo({}, data => {
            ...
            if(Number(data.t_cambio.tasa) > 0){
              ...
              this.$toast({
                    ...
                    props: {
                      title: 'Notificación',
                      icon: 'CheckIcon',
                      text: 'No se pudo encontrar tasa de cambio para el dia de hoy.',
                      variant: 'warning',
                    }
                  },
                  {
          ...
          if (validacion === 0) {
            ...
            if (i === 0) {
              ...
              if (self.detalleForm.aplicaIR) {
                monto_retencion_ir = Round.round(((self.detalleForm.monto_me * self.form.t_cambio) * 0.02) / iva, 2);
                monto_retencion_ir_me = Round.round((self.detalleForm.monto_me * 0.02) / iva, 2);
              } else {
                monto_retencion_ir = 0;
                monto_retencion_ir_me = 0;
              }
              ...
              if (self.detalleForm.aplicaIMI) {
                monto_retencion_imi = Round.round(((self.detalleForm.monto_me * self.form.t_cambio  / iva) * 0.01), 2);
                monto_retencion_imi_me = Round.round(((self.detalleForm.monto_me  / iva) * 0.01), 2);
              } else {
                monto_retencion_imi = 0;
                monto_retencion_imi_me = 0;
              }
              ...
              self.form.detalleCuentasxCobrar.push({
                ...
                monto: this.round((self.detalleForm.monto_me * this.form.t_cambio) - monto_retencion_imi - monto_retencion_ir, 2),
                monto_me: this.round(self.detalleForm.monto_me - monto_retencion_imi_me - monto_retencion_ir_me, 2),
                monto_subtotal: this.round(self.detalleForm.monto_me , 2),
                monto_subtotal_mn: this.round((self.detalleForm.monto_me * this.form.t_cambio) , 2),
                monto_retencion_ir: monto_retencion_ir,
                monto_retencion_imi: monto_retencion_imi,
                monto_retencion_ir_me: monto_retencion_ir_me,
                monto_retencion_imi_me: monto_retencion_imi_me,
        ...
        if (self.detalleForm.monto_me > 0) {
          ...
          if (validacion === 0) {
            ...
            if (i === 0) {
              ...
              if (self.detalleForm.aplicaIR) {
                monto_retencion_ir = Round.round(((self.detalleForm.monto_me * self.form.t_cambio)  / iva) * 0.02, 2);
                monto_retencion_ir_me = Round.round((self.detalleForm.monto_me  / iva) * 0.02, 2);
              } else {
                monto_retencion_ir = 0;
                monto_retencion_ir_me = 0;
              }
              ...
              self.form.detalleCuentasxCobrar.push({
                cuentax: self.detalleForm.cuentax,
                monto: this.round((self.detalleForm.monto_me * this.form.t_cambio) - monto_retencion_imi , 2),
                monto_me: this.round((self.detalleForm.monto_me)  - monto_retencion_imi_me - monto_retencion_ir_me , 2),
                monto_subtotal: this.round(self.detalleForm.monto_me , 2),
                monto_subtotal_mn: this.round((self.detalleForm.monto_me * this.form.t_cambio) , 2),
                monto_retencion_ir: monto_retencion_ir,
      ...
      if (self.detalleForm.monto_me > 0) {
        ...
        if (validacion === 0) {
          ...
          if (i === 0) {
            ...
            if (self.detalleForm.aplicaIR) {
              monto_retencion_ir = Round.round((self.detalleForm.monto_me * self.form.t_cambio) * 0.02, 2);
              monto_retencion_ir_me = Round.round(self.detalleForm.monto_me * 0.02, 2);
            } else {
              monto_retencion_ir = 0;
              monto_retencion_ir_me = 0;
            }
            ...
            if (self.detalleForm.aplicaIMI) {
              monto_retencion_imi = Round.round((self.detalleForm.monto_me * self.form.t_cambio) * 0.01, 2);
              monto_retencion_imi_me = Round.round(self.detalleForm.monto_me * 0.01, 2);
            } else {
              monto_retencion_imi = 0;
              monto_retencion_imi_me = 0;
            }
      ...
      if (self.form.monto_total > 0 && self.form.pago_pendiente > 0) {
        ...
        this.$toast({
              ...
              props: {
                title: 'Notificación',
                icon: 'CheckIcon',
                text: 'Aun tiene monto pendiente por pagar.',
                variant: 'warning',
              }
            },
            {
