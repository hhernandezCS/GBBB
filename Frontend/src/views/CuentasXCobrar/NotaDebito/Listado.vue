  ...
  <b-card>
      <b-row>
        <b-col cols="12" md="6" class="sm-text-center">
          <router-link class="btn btn-success" tag="button" :to="{ name: 'cxc-notas-debito-registrar' }">
              ...
              <tr :key="nota_debito.id_nota_debito">
                ...
                <td class="text-center">
                  <router-link
                          ...
                          :to="{ name: 'cxc-notas-debito-mostrar', params: { id_nota_debito: nota_debito.id_nota_debito } }"
                          tag="a"
                  >
...
import nota_debito from "../../../api/CuentasXCobrar/notas_debito";
