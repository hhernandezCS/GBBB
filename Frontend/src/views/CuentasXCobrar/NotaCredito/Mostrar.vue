                    ...
                    <div class="row">
                        <div class="col col-8">
                            ...
                            <template v-if="form.nota_credito_cliente">
                                ...
                                <span v-show="form.nota_credito_sucursal">{{ form.nota_credito_sucursal?', Sucursal: ' + form.nota_credito_sucursal.nombre_comercial:'' }}</span>
                            </template>
                            <template v-else>
                                <span>N/A</span>
                            </template>
...
<script type="text/ecmascript-6">
    import notas from "../../../api/CuentasXCobrar/notas_credito";
