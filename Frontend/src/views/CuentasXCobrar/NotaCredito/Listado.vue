  ...
  <b-card>
      <b-row>
        <b-col class="sm-text-center" cols="12" md="6">
          <router-link class="btn btn-success" tag="button" :to="{ name: 'cxc-notas-credito-registrar' }">
            <i class="pe-7s-plus"></i> Registrar N/C
          </router-link>
        </b-col>
        <b-col class="sm-text-center form-inline justify-content-end" cols="12" md="6" @keyup.enter="filter.page = 1;obtenerNotasCredito();">
          <b-form-select
          ...
          <b-form-input
            ...
            type="text"
          />
          <b-button variant="info" @click="filter.page = 1;obtenerNotasCredito();">
            <feather-icon icon="SearchIcon"></feather-icon> Buscar
          </b-button>
        </b-col>
      </b-row>
...
<script type="text/ecmascript-6">
  import nota_credito from "../../../api/CuentasXCobrar/notas_credito";
