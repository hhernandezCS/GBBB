...
<!--                    <div class="col-md-5">
                    ...
                    <div class="col-md-3.5 mr-1">
                        ...
                        <b-form-datepicker
                                :date-format-options="{ year: 'numeric', month: 'numeric', day: 'numeric' }"
                                @selected="onDateSelectRFDInicial"
                                class="mb-0"
                                local="es"
                                placeholder="f.inicial"
                                selected-variant="primary"
                                v-model="formFacturasDetallado.f_inicial"
                        ></b-form-datepicker>
                    </div>
                    <div class="col-md-3.5">
                        <label for="fecha_final">* Fecha Final:</label>
                        <b-form-datepicker
                                :date-format-options="{ year: 'numeric', month: 'numeric', day: 'numeric' }"
                                @selected="onDateSelectRFDFinal"
                                class="mb-0"
                                local="es"
                                placeholder="f.final"
                                selected-variant="primary"
                                v-model="formFacturasDetallado.f_final"
                        ></b-form-datepicker>
                    </div>
                    <div class="col-md-12 mt-1">
                        <a :disabled="descargando"
                           @click.prevent="downloadReporteFacturasDetallado ('pdf', formFacturasDetallado.f_inicial, formFacturasDetallado.f_final)"
                           style="color: #ffffff;padding-left: 2px">
                            <b-button :disabled="descargando" class="mt-1 mr-1" v-b-tooltip.hover.top="'Descargar PDF'"
                                      variant="danger"> PDF
                                <feather-icon icon="DownloadCloudIcon"></feather-icon>
                        ...
                        <a :disabled="descargando"
                           @click.prevent="downloadReporteFacturasDetallado ('xls', formFacturasDetallado.f_inicial, formFacturasDetallado.f_final)"
                           style="color: #ffffff;padding-left: 2px">
                            <b-button :disabled="descargando" class="mt-1" v-b-tooltip.hover.top="'Descargar XLS'"
                                      variant="success"> XLS
                                <feather-icon icon="DownloadCloudIcon"></feather-icon>
      ...
      <div class="col-sm-3 col-md-6">
        <b-card>
          ...
          <b-row>
            <div class="col-md-12">
              <label for="id_cliente">* Clientes:</label>
              <v-select :options="formListadoRecibo.clientes"
                        label="nombre_comercial"
                        v-model="formListadoRecibo.clienteSelecionado"
                        id="id_cliente"
            ...
            <div class="col-md-12 mr-1">
              ...
              <b-form-datepicker
                  :date-format-options="{ year: 'numeric', month: 'numeric', day: 'numeric' }"
                  @selected="onDateSelectRLRInicial"
                  class="mb-0"
                  local="es"
                  placeholder="f.inicial"
                  selected-variant="primary"
                  v-model="formListadoRecibo.f_inicial"
              ></b-form-datepicker>
            </div>
            <div class="col-md-12">
              <label for="fecha_final">* Fecha Final:</label>
              <b-form-datepicker
                  :date-format-options="{ year: 'numeric', month: 'numeric', day: 'numeric' }"
                  @selected="onDateSelectRLRFinal"
                  class="mb-0"
                  local="es"
                  placeholder="f.final"
                  selected-variant="primary"
                  v-model="formListadoRecibo.f_final"
              ></b-form-datepicker>
            </div>
            <div class="col-md-12 mt-1">
              <a :disabled="descargando"
                 @click.prevent="downloadReporteListadodeRecibo ('pdf',formListadoRecibo.clienteSelecionado.id_cliente, formListadoFactura.f_inicial,formListadoFactura.f_final)"
                 style="color: #ffffff;padding-left: 2px">
                <b-button :disabled="descargando" class="mt-1 mr-1" v-b-tooltip.hover.top="'Descargar PDF'"
                          variant="danger"> PDF
                  <feather-icon icon="DownloadCloudIcon"></feather-icon>
              ...
              <a :disabled="descargando"
                 @click.prevent="downloadReporteListadodeRecibo ('xls',formListadoRecibo.clienteSelecionado.id_cliente, formListadoFactura.f_inicial,formListadoFactura.f_final)"
                 style="color: #ffffff;padding-left: 2px">
                <b-button :disabled="descargando" class="mt-1" v-b-tooltip.hover.top="'Descargar XLS'"
                          variant="success"> XLS
                  <feather-icon icon="DownloadCloudIcon"></feather-icon>
        ...
        <!--Reporte comparativo salidas de inventario vs contabilidad-->
        <div class="col-lg-6 col-md-6 ">
            <b-card>
                <h3>
                    Comparativo salidas de inventario - contabilidad
                </h3>
                <b-row>
                  <div class="col-md-12 mr-1">
                    <label for="fecha_inicial">* Fecha Inicial:</label>
                    <b-form-datepicker
                        :date-format-options="{ year: 'numeric', month: 'numeric', day: 'numeric' }"
                        @selected="onDateSelectRCICInicial"
                        class="mb-0"
                        local="es"
                        placeholder="f.inicial"
                        selected-variant="primary"
                        v-model="formComparativoSalidasContabilidad.fecha_inicial"
                    ></b-form-datepicker>
                  </div>
                  <div class="col-md-12">
                    <label for="fecha_final">* Fecha Final:</label>
                    <b-form-datepicker
                        :date-format-options="{ year: 'numeric', month: 'numeric', day: 'numeric' }"
                        @selected="onDateSelectRCICFinal"
                        class="mb-0"
                        local="es"
                        placeholder="f.final"
                        selected-variant="primary"
                        v-model="formComparativoSalidasContabilidad.fecha_final"
                    ></b-form-datepicker>
                  </div>
                    <div class="col-md-5 mt-2">
                        <a :disabled="descargando"
                           @click.prevent="downloadItemComparativoSalidasContabilidad('pdf',formComparativoSalidasContabilidad.fecha_inicial,formComparativoSalidasContabilidad.fecha_final)"
                           style="color: #ffffff;padding-left: 2px">
                            <b-button :disabled="descargando" class="mt-1 mr-1" v-b-tooltip.hover.top="'Descargar'"
                                      variant="danger"> PDF
                                <feather-icon icon="DownloadCloudIcon"></feather-icon>
                        ...
                        <a :disabled="descargando"
                           @click.prevent="downloadItemComparativoSalidasContabilidad('xls',formComparativoSalidasContabilidad.fecha_inicial,formComparativoSalidasContabilidad.fecha_final)"
                           style="color: #ffffff;padding-left: 2px">
                            <b-button :disabled="descargando" class="mt-1" v-b-tooltip.hover.top="'Descargar'"
                                      variant="success"> XLS
                                <feather-icon icon="DownloadCloudIcon"></feather-icon>
  ...
  export default {
    ...
    data() {
      return {
        ...
        formComparativoSalidasContabilidad:{
    ...
    methods: {
      ...
      //Selecionar las fecha para Reporte comparativo entre salidas de inventario y contabilidad
      onDateSelectRCICInicial(date) {
        this.formComparativoSalidasContabilidad.fecha_inicial = moment(date).format("YYYY-MM-DD"); //
      },
      onDateSelectRCICFinal(date) {
        this.formComparativoSalidasContabilidad.fecha_final = moment(date).format("YYYY-MM-DD"); //
      },

      /*
      *Reporte comparativo entre salidas de inventario y contabilidad
      * */
      downloadItemComparativoSalidasContabilidad(extension, fecha_inicial, fecha_final) {
        const self = this;
        if (!this.descargando) {
          self.loading = true;
          let url = 'contabilidad/comparativo-salidas-contabilidad/reporte/' + extension + '/' + fecha_inicial + '/' + fecha_final;
          this.descargando = true;
          axios.get(url, {responseType: 'blob'})
              .then(({data}) => {
                let blob = new Blob([data], {type: 'application/pdf'});
                ...
                let link = document.createElement('a');
                link.href = window.URL.createObjectURL(blob);
                link.download = 'ReporteComparativoSalidasContabilidad.' + extension;
                link.click()
                //this.descargando = false;
                self.loading = false;
                self.descargando = false;
      ...
      downloadReporteFacturasDetallado(extension, f_inicial, f_final) {
        const self = this;
        if (!this.descargando) {
          self.loading = true;
          let url = 'contabilidad/reporte/detallado-facturas/' + extension  + '/' + f_inicial + '/' + f_final;
          this.descargando = true;
          axios.get(url, {responseType: 'blob'})
              .then(({data}) => {
                let blob = new Blob([data], {type: 'application/pdf'})
                ...
                let link = document.createElement('a');
                link.href = window.URL.createObjectURL(blob)
                link.download = 'FacturasDetalladas.' + extension;
                link.click()
                //this.descargando = false;
                self.loading = false;
                self.descargando = false;
      ...
      onDateSelectRFDInicial(date) {
        this.formFacturasDetallado.f_inicial = moment(date).format("YYYY-MM-DD"); //
      },
      onDateSelectRFDFinal(date) {
        this.formFacturasDetallado.f_final = moment(date).format("YYYY-MM-DD"); //
      },
      obtenerTodasBodegas() {
        const self = this;
        self.loading = true;
      ...
      //Selecionar las fecha de listado de recibo
      onDateSelectRLRInicial(date) {
        this.formListadoRecibo.f_inicial = moment(date).format("YYYY-MM-DD"); //
      },
      onDateSelectRLRFinal(date) {
        this.formListadoRecibo.f_final = moment(date).format("YYYY-MM-DD"); //
      },

      obtenerCatalagoRecibo() {
        let self = this;
        self.loading = true;
        catalogo.obtenerCatalago(
            data => {
              self.loading = false;
              self.formListadoRecibo.clientes = data.clientes
              //Metodo de notificacion
              this.$toast({
                component: ToastificationContent,
                props: {
      ...
      downloadReporteListadodeRecibo(extension, id_cliente,fecha_inicial, fecha_final) {
        const self = this;
        if (!this.descargando ) {
          self.loading = true;
          let url = 'contabilidad/listado-de-recibo/' + extension + '/' + id_cliente +  '/' + fecha_inicial + '/' + fecha_final;
          this.descargando = true;
          axios.get(url, {responseType: 'blob'})
              .then(({data}) => {
                let blob = new Blob([data], {type: 'application/pdf'})
                ...
                let link = document.createElement('a');
                link.href = window.URL.createObjectURL(blob)
                link.download = 'ListadoDeRecibo.' + extension;
                link.click()
                //this.descargando = false;
                self.loading = false;
                self.descargando = false;
