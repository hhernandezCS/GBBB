      ...
      nuevo() {
        ...
        documento_contable.nuevo({}, data => {
              ...
              if (data?.t_cambio?.tasa === undefined || Number(data.t_cambio.tasa) === 0) {
                ...
                self.filter.search.anio = self.form.fecha_emision.split("-")[0];
                self.filter.search.mes = self.form.fecha_emision.split("-")[1];
