                ...
                <b-row>
                    <div class="col-md-6" v-if="form.clasificacion_compra_cuenta_contable.requiere_aux === 0">
                        ...
                        <input class="form-control" placeholder="No requiere codigo auxiliar"
                               readonly v-model="form.notRequiered">
                    </div>
        ...
        <b-card-footer class="row mt-2">
                <div class="col-md-6 col-sm-12  text-md-left text-sm-center text-center">
                    <template v-if="form.activo">
                        <b-button @click="desactivar(form.id_clasificacion_servicio)" variant="danger" class="mb-md-0 mb-lg-0 mb-1">
                            <feather-icon
                    ...
                    <template v-else>
                        <b-button @click="activar(form.id_clasificacion_servicio)" variant="success" class="mb-md-0 mb-lg-0 mb-1">
                            <feather-icon
                ...
                <div class="col-md-6 col-sm-12 text-md-right text-sm-center text-center">
                    <router-link :to="{ name: 'clasificacion-compras' }">
                        <b-button variant="secondary"  class="mr-1">Cancelar</b-button>
                    </router-link>
                    <b-button :disabled="btnAction !== 'Guardar'" @click="actualizar"
                              type="button" variant="primary">{{ btnAction }}
                    </b-button>
                </div>
        ...
        clasificacion.obtenerClasificacion({
          ...
          this.$toast({
                ...
                props: {
                  title: 'Notificación',
                  icon: 'CheckIcon',
                  text: err.id_clasificacion_servicio[0],
                  variant: 'warning',
                }
              },
              {
