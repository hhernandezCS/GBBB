<template>
  <b-card>
    <b-row>
      <div class="col-md-3 sm-text-center">
        <router-link class="btn btn-success" tag="button"
                     :to="{ name: 'activofijo-grupos-registrar' }">
            ...
            <td class="text-center">
              <template>
                <router-link v-b-tooltip="'Actualizar Grupo'"
                             :to="{name: 'activofijo-grupos-actualizar', params: {id_grupo_activo: grupo.id_grupo_activo}}"
                             tag="a">
    ...
    <b-card-footer>
      <pagination @changePage="changePage" @changeLimit="changeLimit" :items="grupos" :total="total"
