      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="form-group">
            <label for="name"><span style="color: red">*</span>  Nombre Tipo Activo:</label>
            <input type="text" class="form-control" v-model="form.descripcion" placeholder="Dígite el nombre del tipo activo">
