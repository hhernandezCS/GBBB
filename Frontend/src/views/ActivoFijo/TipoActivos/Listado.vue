    ...
    <b-row>
      <div class="col-md-3 sm-text-center">
        <router-link class="btn btn-success" tag="button"
                     :to="{ name: 'activofijo-tiposactivos-registrar' }">
    ...
    <div class="table-responsive mt-3">
      <table class="table table-striped table-bordered">
        ...
        <template v-for="tipo in tipos">
          <tr :key="tipo.id_tipo_activo">
            <td>{{ '00'+tipo.id_tipo_activo }}</td>
            ...
            <td class="text-center">
              <template>
                <router-link v-b-tooltip="'Actualizar Tipo activo'"
                             :to="{name: 'activofijo-tiposactivos-actualizar', params: {id_tipo_activo: tipo.id_tipo_activo}}"
                             tag="a">
