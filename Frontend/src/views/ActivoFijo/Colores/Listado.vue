<template>
  <b-card>
    <b-row>
      <div class="col-md-3 sm-text-center">
        <router-link class="btn btn-success" tag="button"
                     :to="{ name: 'activofijo-colores-registrar' }">
      ...
      <table class="table table-striped table-bordered">
        ...
        <template v-for="color in colores">
          <tr :key="color.id_color">
            ...
            <td class="text-center">
              <template>
                <router-link v-b-tooltip="'Actualizar color'"
                             :to="{name: 'activofijo-colores-actualizar', params: {id_color: color.id_color}}"
                             tag="a">
    ...
    <b-card-footer>
      <pagination @changePage="changePage" @changeLimit="changeLimit" :items="colores" :total="total"
...
import color from '../../../api/ActivoFijo/Colores'
