  ...
  <b-card>
    <b-row>
      <div class="col-md-3 sm-text-center">
        <router-link class="btn btn-success" tag="button"
                     :to="{ name: 'activofijo-propietarios-registrar' }">
    ...
    <div class="table-responsive mt-3">
      <table class="table table-striped table-bordered">
        ...
        <tbody>
        <template v-for="propietario in propietarios">
            ...
            <td class="text-center">
              <template>
                <router-link v-b-tooltip="'Actualizar Grupo'"
                             :to="{name: 'activofijo-propietarios-actualizar', params: {id_propietario: propietario.id_propietario}}"
                             tag="a">
    ...
    <b-card-footer>
      <pagination @changePage="changePage" @changeLimit="changeLimit" :items="propietarios" :total="total"
