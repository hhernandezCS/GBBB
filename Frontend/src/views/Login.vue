<template>
    <div class="auth-wrapper auth-v2">
        <b-row class="auth-inner m-0">
            ...
            <!-- Login-->
            <b-col
                    class="auth-bg px-2 p-lg-5"
                    lg="4"
            >
                <!-- Brand logo-->
                <b-link class="brand-logo">
                    <b-img class="logo" :src="appLogo" fluid-grow/>
        ...
        methods: {
                    ...
                    if (success) {
                        this.$store.dispatch('login', {
                            ...
                            .then((response) => {
                                ...
                                if (this.$store.state.auth.status === 423) {
                                    this.$toast({
                                        component: ToastificationContent,
                                        position: 'top-right',
                                        props: {
                                            ...
                                            icon: 'CoffeeIcon',
                                            variant: 'danger',
                                            text: 'Este usuario no tiene permitido acceder al sistema.',
                                        },
                                    });
                                    this.btnAction = 'Inicia sesión'
                                }
          ...
          cargarAjustes() {
            ...
            ajustes_generales.cargarRecursos(data => {
                  ...
                  this.recursos = data;
                  this.appLogo = this.recursos.host + this.recursos.logo_left.valor;
