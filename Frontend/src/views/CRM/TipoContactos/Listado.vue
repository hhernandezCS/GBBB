  ...
  <b-card>
    <b-row>
      <div class="col-md-3 sm-text-center">
        <router-link class="btn btn-success" tag="button"
                     :to="{ name: 'crm-tipo-contactos-registrar' }">
    ...
    <div class="table-responsive mt-3">
      <table class="table table-striped table-bordered">
        ...
        <tbody>
        <template v-for="tipo_contacto in tipo_contactos">
          <tr :key="tipo_contacto.id_tipo_contacto">
            <td>{{ tipo_contacto.descripcion }}</td>
            <td class="text-center">
              <div v-if="tipo_contacto.estado===1">
            ...
            <td class="text-center">
              <template>
                <router-link v-b-tooltip="'Actualizar Servicio'"
                             :to="{name: 'crm-tipo-contactos-actualizar', params: {id_tipo_contacto: tipo_contacto.id_tipo_contacto}}"
                             tag="a">
    ...
    <b-card-footer>
      <pagination @changePage="changePage" @changeLimit="changeLimit" :items="tipo_contactos" :total="total"
...
export default {
  ...
  methods: {
    ...
    obtener() {
      var self = this;
      self.loading = true;
      tipoContacto.obtener(
          self.filter,
          data => {
            self.tipo_contactos = data.rows;
