            ...
            <b-row>
                <div class="col-md-6 text-left p-0">
                    <template v-if="form.estado">
                        <b-button type="submit" variant="danger" @click="desactivar(form.id_clasificacion_llamada)">
                            <feather-icon icon="Trash2Icon"></feather-icon> Eliminar
                        </b-button>
                    </template>
                    <template v-else>
                        <b-button type="submit" variant="success" @click="activar(form.id_clasificacion_llamada)">
...
<script type="text/ecmascript-6">
    ...
    import llamada from "../../../api/CRM/ClasificacioLlamada";
    ...
    export default {
        ...
        methods: {
            ...
            obtenerClasificacion(){
                var self = this;
                llamada.obtenerClasificacionLlamada({
                    id_clasificacion_llamada: this.$route.params.id_clasificacion_llamada
                }, data =>{
                    self.form = data;
                    self.loading = false;
                }, err =>{
                    ...
                    this.$router.push({
                        name : 'crm-clasificacion-llamada'
                    })
                })
            },
            ...
            actualizar(){
                ...
                self.loading = true;
                llamada.actualizar(self.form, data =>{
                        self.loading = false;
                        this.$toast({
                                component : ToastificationContent,
                                props: {
            ...
            activar(llamadaID){
                ...
                self.$swal({
                    ...
                    if (result.value){
                        ...
                        llamada.activar({
                            id_clasificacion_llamada: llamadaID
                        }, data =>{
                            this.$router.push({
                                name : 'crm-clasificacion-llamada'
                            })
            ...
            desactivar(llamadaID){
                ...
                self.$swal({
                    ...
                    if (result.value){
                        ...
                        llamada.desactivar({id_clasificacion_llamada: llamadaID
                            },
                            data =>{
                                this.$router.push({
                                    name : 'crm-clasificacion-llamada'
                        ...
                        self.$swal({
                            title: 'Cancelado',
                            text: 'La clasificacion no ha sido eliminada',
                            icon: 'error',
                            customClass: {
                                confirmButton: 'btn btn-success',
                            },
