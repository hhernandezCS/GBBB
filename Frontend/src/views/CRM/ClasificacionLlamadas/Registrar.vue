            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label for="name">* Nombre Clasificación:</label>
                        <input type="text" class="form-control" v-model="form.descripcion" placeholder="Dígite la clasificación">
    ...
    export default {
        ...
        methods: {
            registrar(){
                ...
                self.loading = true;
                llamada.registrar(self.form, data =>{
                        self.loading = false;
                        this.$toast({
