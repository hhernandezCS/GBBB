    ...
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'crm-clasificacion-llamada-registrar' }">
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <template v-for="llamada in llamadas">
                    <tr :key="llamada.id_clasificacion_llamada">
                        <td>{{ llamada.descripcion }}</td>
                        <td class="text-center">
                            <div v-if="llamada.estado===1">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Clasificación Llamada'"
                                             :to="{name: 'crm-clasificacion-llamada-actualizar', params: {id_clasificacion_llamada: llamada.id_clasificacion_llamada}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="llamadas" :total="total"
