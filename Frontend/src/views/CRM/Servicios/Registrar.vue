<template>
    <b-card>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" v-model="form.descripcion" placeholder="Dígite el servicio">
        ...
        <b-card-footer class="content-box-footer text-right mt-1">
            ...
            <router-link  :to="{name: 'crm-servicios'}">
    ...
    export default {
        ...
        methods: {
            registrar(){
                ...
                self.loading = true;
                servicio.registrar(self.form, data =>{
                        self.loading = false;
                        this.$toast({
