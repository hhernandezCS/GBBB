<template>
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'crm-servicios-registrar' }">
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <template v-for="servicio in servicios">
                    <tr :key="servicio.id_servicio_ofr_acor">
                        <td>{{ servicio.descripcion }}</td>
                        <td class="text-center">
                            <div v-if="servicio.estado===1">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Servicio'"
                                             :to="{name: 'crm-servicios-actualizar', params: {id_servicio_ofr_acor: servicio.id_servicio_ofr_acor}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="servicios" :total="total"
