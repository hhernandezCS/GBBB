    ...
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'crm-origenes-registrar' }">
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <template v-for="origen in origenes">
                    <tr :key="origen.id_origen_lead">
                        <td>{{ origen.descripcion }}</td>
                        <td class="text-center">
                            <div v-if="origen.estado===1">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Origenes'"
                                             :to="{name: 'crm-origenes-actualizar', params: {id_origen_lead: origen.id_origen_lead}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="origenes" :total="total"
