  ...
  <b-card>
    <b-row>
      <div class="col-md-3 sm-text-center">
        <router-link class="btn btn-success" tag="button"
                     :to="{ name: 'crm-clasificacion-contactos-registrar' }">
    ...
    <div class="table-responsive mt-3">
      <table class="table table-striped table-bordered">
        ...
        <tbody>
        <template v-for="clasificacion_contacto in clasificacion_contactos">
          <tr :key="clasificacion_contacto.id_clasificacion_contacto">
            <td>{{ clasificacion_contacto.descripcion }}</td>
            <td class="text-center">
              <div v-if="clasificacion_contacto.estado===1">
            ...
            <td class="text-center">
              <template>
                <router-link v-b-tooltip="'Actualizar Clasificación'"
                             :to="{name: 'crm-clasificacion-contactos-actualizar', params: {id_clasificacion_contacto: clasificacion_contacto.id_clasificacion_contacto}}"
                             tag="a">
        ...
        <tr v-if="!clasificacion_contactos.length">
    ...
    <b-card-footer>
      <pagination @changePage="changePage" @changeLimit="changeLimit" :items="clasificacion_contactos" :total="total"
...
export default {
  ...
  methods: {
    ...
    obtener() {
      var self = this;
      self.loading = true;
      clasificacionContacto.obtener(
          self.filter,
          data => {
            self.clasificacion_contactos = data.rows;
