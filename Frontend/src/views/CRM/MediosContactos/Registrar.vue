<template>
  <b-card>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="form-group">
            <label for="name">* Medio de contacto:</label>
            <input type="text" class="form-control" v-model="form.descripcion" placeholder="Dígite el medio de contacto">
    ...
    <b-card-footer class="content-box-footer text-right mt-1">
      ...
      <router-link  :to="{name: 'crm-medios-contacto'}">
...
export default {
  ...
  methods: {
    registrar(){
      ...
      self.loading = true;
      medioContacto.registrar(self.form, data =>{
            self.loading = false;
            this.$toast({
