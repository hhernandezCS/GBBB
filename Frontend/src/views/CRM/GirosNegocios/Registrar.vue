<template>
    <b-card>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label for="name">* Nombre Giro empresa:</label>
                        <input type="text" class="form-control" v-model="form.descripcion" placeholder="Dígite el giro de la empresa">
        ...
        <b-card-footer class="content-box-footer text-right mt-1">
            ...
            <router-link  :to="{name: 'crm-giros-negocios'}">
