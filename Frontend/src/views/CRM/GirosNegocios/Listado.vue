    ...
    <b-card>
        <b-row>
            <div class="col-md-3 sm-text-center">
                <router-link class="btn btn-success" tag="button"
                             :to="{ name: 'crm-giros-negocios-registrar' }">
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <template v-for="giro in giros">
                    <tr :key="giro.id_giro_negocio">
                        <td>{{ giro.descripcion }}</td>
                        <td class="text-center">
                            <div v-if="giro.estado===1">
                        ...
                        <td class="text-center">
                            <template>
                                <router-link v-b-tooltip="'Actualizar Giro de negocio'"
                                             :to="{name: 'crm-giros-negocios-actualizar', params: {id_giro_negocio: giro.id_giro_negocio}}"
                                             tag="a">
        ...
        <b-card-footer>
            <pagination @changePage="changePage" @changeLimit="changeLimit" :items="giros" :total="total"
