            ...
            <b-row>
                <div class="col-md-6 text-left p-0">
                    <template v-if="form.estado">
                        <b-button type="submit" variant="danger" @click="desactivar(form.id_cargo)">
                            <feather-icon icon="Trash2Icon"></feather-icon> Eliminar
                        </b-button>
                    </template>
                    <template v-else>
                        <b-button type="submit" variant="success" @click="activar(form.id_cargo)">
                ...
                <div class="col-md-6">
                    <router-link  :to="{name: 'crm-cargos'}">
    ...
    export default {
        ...
        methods: {
            ...
            obtenercargo(){
                const self = this;
                cargo.obtenerCargos({
                    id_cargo: this.$route.params.id_cargo
                }, data =>{
                    self.form = data;
                    self.loading = false;
                }, err =>{
            ...
            activar(cargoID){
                ...
                self.$swal({
                    ...
                    if (result.value){
                        ...
                        self.$swal({
                            title: 'Cancelado',
                            text: 'El cargo no ha sido habilitado',
                            icon: 'error',
                            customClass: {
                                confirmButton: 'btn btn-success',
                            },
            ...
            desactivar(cargoID){
                ...
                self.$swal({
                    title: 'Info!',
                    text: '¿Esta seguro de desactivar el cargo?',
                    icon: 'info',
                    showCancelButton: true,
                    confirmButtonText : 'Si, confirmar',
                    cancelButtonText : 'Cancelar',
                    ...
                    if (result.value){
                        self.$swal({
                            icon :'success',
                            title : '¡Desactivado!',
                            text : '¡Cargo Desactivado!',
                            customClass: {
                                confirmButton : 'btn btn-success',
                            }
                        });
                        cargo.desactivar({id_cargo: cargoID
                            },
                            data =>{
                                this.$router.push({
                                    name : 'crm-cargos'
                        ...
                        self.$swal({
                            title: 'Cancelado',
                            text: 'El cargo no ha sido eliminado',
                            icon: 'error',
                            customClass: {
                                confirmButton: 'btn btn-success',
                            },
