<template>
  <b-card>
    <b-row>
      <div hidden class="col-md-3 sm-text-center">
        <router-link class="btn btn-success" tag="button"
                     :to="{ name: 'cajabanco-viapagos-registrar' }">
    ...
    <div class="table-responsive mt-3">
      <table class="table table-striped table-bordered">
        ...
        <tr>
          ...
          <th hidden class="text-center table-number">Opciones</th>
        </tr>
        </thead>
        <tbody>
        <template v-for="viapago in viapagos">
          <tr :key="viapago.id_via_pago">
            <td>{{ viapago.descripcion }}</td>
            <td>
              <div v-if="viapago.estado===1">
            ...
            <td hidden class="text-center">
              <template>
                <router-link v-b-tooltip="'Actualizar Via de pago'"
                             :to="{name: 'cajabanco-viapagos-actualizar', params: {id_via_pago: viapago.id_via_pago}}"
                             tag="a">
    ...
    <b-card-footer>
      <pagination @changePage="changePage" @changeLimit="changeLimit" :items="viapagos" :total="total"
...
import viapago from '../../../api/CajaBanco/via-pago'
