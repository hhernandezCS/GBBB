<template>
  <b-card>
    <b-row>
      <div class="col-md-3 sm-text-center">
        <router-link class="btn btn-success" tag="button"
                     :to="{ name: 'cajabanco-Normativas-registrar' }">
    ...
    <div class="table-responsive mt-3">
      <table class="table table-striped table-bordered">
        ...
        <tr>
          ...
          <th>Concepto</th>
          <th class="text-center">Monto Min C$</th>
          <th class="text-center">Monto Max C$</th>
        ...
        <tbody>
        <template v-for="normativa in normativas">
          <tr :key="normativa.id_normativa">
            <td>{{ normativa.concepto }}</td>
            <td class="text-center">{{ normativa.monto_minimo }}</td>
            <td class="text-center">{{ normativa.monto_maximo }}</td>
            <td>{{ normativa.tiempo }}</td>
            <td class="text-center">
              <div v-if="normativa.estado===1">
            ...
            <td class="text-center">
              <template>
                <router-link v-b-tooltip="'Actualizar Normativa'"
                             :to="{name: 'cajabanco-Normativas-actualizar', params: {id_normativa: normativa.id_normativa}}"
                             tag="a">
    ...
    <b-card-footer>
      <pagination @changePage="changePage" @changeLimit="changeLimit" :items="normativas" :total="total"
