  ...
  <b-card>
    <b-row>
      <div class="col-md-3 sm-text-center">
        <router-link class="btn btn-success" tag="button"
                     :to="{ name: 'cajabanco-afectaciones-registrar' }">
          <feather-icon icon="PlusCircleIcon"></feather-icon>
          Registrar
        </router-link>
      </div>

      <div @keyup.enter="filter.page = 1;obtenerAfectaciones();"
        ...
        <input v-model="filter.search.value" class="form-control mb-1 mr-sm-1 mb-sm-0" placeholder="Buscar"
               type="text">
        <b-button variant="info" @click="filter.page = 1;obtenerAfectaciones();"
    ...
    <div class="table-responsive mt-3">
      <table class="table table-striped table-bordered">
        ...
        <tbody>
        <template v-for="afectacion in afectaciones">
          <tr :key="afectacion.id_afectacion">
            ...
            <td class="text-center">
              <template>
                <router-link v-b-tooltip="'Actualizar Afectación'"
                             :to="{name: 'cajabanco-afectaciones-actualizar', params: {id_afectacion: afectacion.id_afectacion}}"
                             tag="a">
    ...
    <b-card-footer>
      <pagination @changePage="changePage" @changeLimit="changeLimit" :items="afectaciones" :total="total"
