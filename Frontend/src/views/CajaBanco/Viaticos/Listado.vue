  ...
  <b-card>
    <b-row>
      <div class="col-md-3 sm-text-center">
        <router-link class="btn btn-success" tag="button"
                     :to="{ name: 'cajabanco-viaticos-registrar' }">
    ...
    <div class="table-responsive mt-3">
      <table class="table table-striped table-bordered">
        ...
        <tbody>
        <template v-for="viatico in viaticos">
          <tr :key="viatico.id_viatico">
            <td>{{ viatico.descripcion }}</td>
            <td class="text-center">{{ viatico.normativa_viatico.concepto }}</td>
            <td class="text-center">{{ viatico.monto }}</td>
            <td class="text-center">
              <div v-if="viatico.estado===1">
            ...
            <td class="text-center">
              <template>
                <router-link v-b-tooltip="'Actualizar Normativa'"
                             :to="{name: 'cajabanco-viaticos-actualizar', params: {id_viatico: viatico.id_viatico}}"
                             tag="a">
    ...
    <b-card-footer>
      <pagination @changePage="changePage" @changeLimit="changeLimit" :items="viaticos" :total="total"
