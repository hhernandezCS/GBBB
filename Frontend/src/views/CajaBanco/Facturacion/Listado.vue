        ...
        <template v-for="(factura,key) in facturas">
          <tr :key="factura.id_factura">
            ...
            <td class="text-center">
              ...
              <!-- Column: Action -->
              <span>
                                <b-dropdown variant="link" toggle-class="text-decoration-none" right text="Center align"
                                            id="dropdown-buttons"
                                            style="position: center !important;" no-caret>
                                    <template v-slot:button-content>
                                        <feather-icon icon="MoreVerticalIcon" size="16"
                                                      class="text-body align-middle mr-25"/>
                                    </template>
                                  <!--Anular Factura-->
                                    <template v-if="([1,99].indexOf(factura.estado) >= 0)">
                                      <b-dropdown-item>
                                                          <a @click.prevent="anular(factura.id_factura)"
                                                             v-if="factura.estado === 1">
                <feather-icon icon="TrashIcon"  class="mr-50" style="color: red"></feather-icon><span>Anular Factura</span>
              </a>
                                      </b-dropdown-item>
                                    </template>
                                  <!--Descargar Factura-->
                                    <template v-if="([1,99].indexOf(factura.estado) >= 0)">
                                      <b-dropdown-item>
                                                       <a :disabled="descargando"
                                                          @click.prevent="downloadItem('pdf',factura.id_factura)"

                                                       >
                <feather-icon aria-hidden="true" icon="DownloadIcon"  class="mr-50"
                              style="color: #0a91ff"></feather-icon><span>Descargar Factura</span>
              </a>
                                  ...
                                  <!--Mostrar detalle de Factura-->
                                    <template>
                                        ...
                                        <router-link
                                            ...
                                            :to="{ name: 'cajabanco-factura-mostrar', params: { id_factura: factura.id_factura } }"
                                            tag="a"
                                        >
            ...
            <td colspan="7">
              <table class="table table-striped">
                ...
                <tr
                  ...
                  <td>{{ productosDetalle.cantidad | formatMoney(2)}}</td>
                </tr>
                </tbody>
                <tfoot>
                <tr>
                  ...
                  <td class="item-footer">
                    <strong>{{ factura.tot_unidades | formatMoney(2) }}</strong>
                  </td>
                </tr>
                </tfoot>
              </table>
