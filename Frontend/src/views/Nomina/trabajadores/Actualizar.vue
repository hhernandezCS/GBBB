...
<script type="text/ecmascript-6">
    ...
    import academico from '@/api/Nomina/niveles_academicos'
    import estudio from '@/api/Nomina/niveles_estudios'
    import medicos from '@/api/Nomina/datos_medicos'
    import cargo from '@/api/Nomina/cargos'
    import departamento from '@/api/admon/departamentos'
/*	import loadingImage from '../../assets/images/block50.gif'*/
    import es from 'vuejs-datepicker/dist/locale/translations/es'
    import parentesco from "@/api/Nomina/parentesco";
