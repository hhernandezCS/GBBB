    ...
    <b-card>
        <b-row>
            <div class="col-md-4 sm-text-center">
                <router-link :to="{ name: 'admon-ciudades-registrar' }" class="btn btn-success" tag="button">
                    <i class="pe-7s-plus"></i> Registrar
                </router-link>
            </div>
            <div @keyup.enter="filter.page = 1;obtenerCiudad();"
                ...
                <b-button class="btn btn-info mx-1" style="margin-right: .5rem!important;"
                          v-b-tooltip.hover.top="'Buscar Estado!'"
                          @click="filter.page = 1; obtenerCiudad();">
        ...
        <div class="table-responsive mt-3">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                <tr :key="ciudad.id_ciudad" v-for="ciudad in ciudades">
                    <td>{{ ciudad.descripcion }}</td>
                    <td class="text-center">{{ ciudad.estado_ciudades.descripcion }}</td>
                    ...
                    <td class="text-center">
                        <router-link tag="a" :to="{ name: 'admon-ciudades-actualizar', params: { id_ciudad: ciudad.id_ciudad } }" v-b-tooltip.hover.top="'Editar registro!'"><feather-icon icon="EditIcon"></feather-icon></router-link>
                    </td>
                </tr>
                <tr v-if="!ciudades.length">
        ...
        <b-card-footer>
            <pagination :items="ciudades" :limit="filter.limit" :limitOptions="filter.limitOptions" :page="filter.page"
    ...
    export default {
        ...
        methods: {
            obtenerCiudad() {
                var self = this;
                self.loading = true;
                ciudad.obtener(self.filter, data => {
                    self.ciudades = data.rows;
