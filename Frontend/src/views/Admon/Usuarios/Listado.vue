...
<script type="text/ecmascript-6">
    import {BFormDatepicker, BRow, BCol, BCard, BCardFooter, BPaginationNav, BFormGroup,BButton,VBTooltip} from 'bootstrap-vue'
    ...
    export default {
        components:{
            BFormDatepicker, BRow, BCol, BCard, BCardFooter, BPaginationNav, BButton,BFormGroup
        },
        directives: {
            'b-tooltip': VBTooltip,
        },
