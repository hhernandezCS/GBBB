                ...
                },
{
    ...
    //inventario
    {
        ...
        component: () => import( /* webpackChunkName: "inventario-reporte" */  '@/views/Inventario/Reportes/Reportes'),
        meta: {
            id_menu : 149,
            pageTitle: 'Reportes',
            requiresAuth: true,
...
//Grupo
    {
        ...
        component: () => import( /* webpackChunkName: "inventario-grupo" */  '@/views/Inventario/Grupo/Listado'),
        meta: {
            id_menu : 152,
            pageTitle: 'Grupos',
            requiresAuth: true,
    ...
    {
        path: '/inventario/grupo/registrar',
        name: 'inventario-grupo-registrar',
        component: () => import( /* webpackChunkName: "inventario-grupo" */  '@/views/Inventario/Grupo/Registrar'),
        meta: {
            id_menu : 153,
            pageTitle: 'Grupos',
            requiresAuth: true,
    ...
    {
        path: '/inventario/grupo/actualizar/:id_grupo',
        name: 'inventario-grupo-actualizar',
        component: () => import( /* webpackChunkName: "inventario-grupo" */  '@/views/Inventario/Grupo/Actualizar'),
        meta: {
            id_menu : 154,
            pageTitle: 'Grupos',
            requiresAuth: true,
...
//SubGrupos
    {
        path: '/inventario/subgrupo',
        name: 'inventario-subgrupo',
        component: () => import( /* webpackChunkName: "inventario-subgrupo" */  '@/views/Inventario/SubGrupo/Listado'),
        meta: {
            id_menu : 155,
            pageTitle: 'SubGrupos',
            requiresAuth: true,
    ...
    {
        path: '/inventario/subgrupo/registrar',
        name: 'inventario-subgrupo-registrar',
        component: () => import( /* webpackChunkName: "inventario-subgrupo" */  '@/views/Inventario/SubGrupo/Registrar'),
        meta: {
            id_menu : 156,
            pageTitle: 'SubGrupos',
            requiresAuth: true,
    ...
    {
        path: '/inventario/subgrupo/actualizar/:id_subgrupo',
        name: 'inventario-subgrupo-actualizar',
        component: () => import( /* webpackChunkName: "inventario-subgrupo" */  '@/views/Inventario/SubGrupo/Actualizar'),
        meta: {
            id_menu : 157,
            pageTitle: 'SubGrupos',
            requiresAuth: true,
