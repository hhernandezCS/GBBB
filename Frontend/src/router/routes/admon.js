...
export default [
    ...
    {
        path: '/admon-formatos-importacion',
        name: 'admon-formatos-importacion',
        component: () => import( /* webpackChunkName: "admon-formatos-importacion" */  '@/views/Admon/ImportacionDeDatos/FormatosDeImportacion'),
        meta: {
            resources: 'ajustes',
            action: 'Leer',
            id_menu:20,
            pageTitle: 'Formatos de importacion',
            requiresAuth: true,
            breadcrumb: [
                {
                    text: 'Formatos de importacion de datos',
                    active: true,
                },
            ],
        },
    ...
    {
        path: '/admon-inicializacion-datos',
        name: 'admon-inicializacion-datos',
        component: () => import( /* webpackChunkName: "admon-inicializacion-datos" */  '@/views/Admon/ImportacionDeDatos/InicializacionDeDatos'),
        meta: {
            resources: 'ajustes',
            action: 'Leer',
            id_menu:20,
            pageTitle: 'Inicializacion de datos',
            requiresAuth: true,
            breadcrumb: [
                {
                    text: 'Formatos de importacion',
                    to: '/admon-formatos-importacion',
                    active: false,
                },
                {
                    text: 'Inicializacion de datos',
                    active: true,
                },
            ],
        },
