export default [
    ...
    {
        path: '/cajabanco/arqueos',
        name: 'cajabanco-arqueos',
        component: () => import( /* webpackChunkName: "cajabanco-arqueos" */  '@/views/CajaBanco/ArqueoCaja/Listado.vue'),
        meta: {
            id_menu : 159,
            pageTitle: 'Arqueos',
            requiresAuth: true,
    ...
    {
        path: '/cajabanco/arqueos/registrar',
        name: 'cajabanco-arqueos-registrar',
        component: () => import( /* webpackChunkName: "cajabanco-arqueos" */  '@/views/CajaBanco/ArqueoCaja/Registrar.vue'),
        meta: {
            id_menu : 159,
            pageTitle: 'Arqueos',
            requiresAuth: true,
    ...
    {
        path: '/cajabanco/arqueos/actualizar/:id_arqueo',
        name: 'cajabanco-arqueos-actualizar',
        component: () => import( /* webpackChunkName: "cajabanco-arqueos" */  '@/views/CajaBanco/ArqueoCaja/Actualizar.vue'),
        meta: {
            id_menu : 159,
            pageTitle: 'Arqueos',
            requiresAuth: true,
    ...
    {
        path: '/cajabanco/factura-mostrar/:id_factura',
        name: 'cajabanco-factura-mostrar',
        component: () => import( /* webpackChunkName: "cajabanco-facturacion-mostrar" */  '@/views/CajaBanco/Facturacion/Preview'),
        meta: {
            id_menu : 158,
            pageTitle: 'Factura',
            requiresAuth: true,
